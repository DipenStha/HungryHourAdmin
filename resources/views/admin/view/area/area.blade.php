...
<body style="background-color: white;">
    ...
    <div style="text-align:center; padding-top:3%; ">
        ...
        <button onclick="window.location.href='{{ route('add_areas') }}'" class="btn" id="add"><i
                class="fa fa-plus"></i>Add Area</button>
        <table>
            <tr>
                <th>Area id</th>
                <th>Area Name</th>
            ...
            @foreach ($areas as $area)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('area.edit_areas', $area->id) }}"><button class="btn"
                                id="edit"><i class="fa fa-pencil"></i>Edit</button></a>
                    </td>
                    <td>
                        <a href="{{ route('area.delete', $area->id) }}"><button class="btn" id="delete"><i
                                    class="fa fa-trash"></i>Delete</button></a>
                    </td>
                </tr>
            @endforeach
        </table>
        <div class="pagination-block" style="text-align: center">{{ $areas->links('layouts.paginationlinks') }}</div>
        <footer>
            <p> &copy; HungryHour. All rights reserved.</p>
        </footer>
    </div>
</body>
