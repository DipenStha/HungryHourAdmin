...
<body style="background-color: white;">
    ...
    <div style="text-align:center; padding-top:3%; ">
        ...
        <button onclick="window.location.href='{{ route('add_foods') }}'" class="btn" id="add"><i
        ...
        <table>
            ...
            @foreach ($foods as $food)
                <tr>
                    ...
                    <td>
                        <a href='{{ route('food.edit_foods', $food->id) }}'><button class="btn" id="edit"><i
                            class="fa fa-pencil"></i>Edit</button></a>
                    </td>
                    <td>
                        <a href="{{ route('food.delete', $food->id) }}"><button class="btn" id="delete"><i
                            class="fa fa-trash"></i>Delete</button></a>
                    </td>
                </tr>
            @endforeach
        </table>
    <div class="pagination-block" style="text-align: center">{{$foods->links('layouts.paginationlinks') }}</div>  
    <footer>
