...
<body style="background-color: white;">
    ...
    <div style="text-align:center; padding-top:3%; ">
        ...
        <button onclick="window.location.href='{{ route('add_restaurants') }}'" class="button" id="add"><i
        ...
        <table>
            ...
            @foreach ($restaurants as $restaurant)
                <tr>
                    ...
                    <td>
                        <a href='{{ route('restaurant.edit_restaurants', $restaurant->id) }}'><button
                                class="button" id="edit"><i class="fa fa-pencil"></i>Edit</button></a>
                    </td>
                    <td>
                        <a href="{{ route('restaurant.delete', $restaurant->id) }}"><button class="button"
        ...
        <div class="pagination-block" style="text-align: center">
            {{ $restaurants->appends(request()->input())->links('layouts.paginationlinks') }}</div>
        <footer>
